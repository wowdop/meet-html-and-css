...
##### Other properties that are available \*(NOT MANDATORY):

1. the `outline-color` property ``````````` - section: general/border-and-outline - @iulia-zburlea
1. the `outline-style` property ``````````` - section: general/border-and-outline - @iulia-zburlea
1. the `outline-width` property ``````````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-image` property ``` - section: general/border-and-outline - @iulia-zburlea
1. the `border-image-repeat` property ````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-image-outset` property ````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-image-slice` property `````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-image-source` property ````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-image-width` property `````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-top-color` property ```````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-right-color` property `````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-bottom-color` property ````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-left-color` property ``````` - section: general/border-and-outline - @iulia-zburlea
...
1. the `border-top-style` property ```````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-right-style` property `````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-bottom-style` property ````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-left-style` property ``````` - section: general/border-and-outline - @iulia-zburlea

1. the `border-top-width` property ```````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-right-width` property `````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-bottom-width` property ````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-left-width` property ``````` - section: general/border-and-outline - @iulia-zburlea
1. the `border-top-right-radius` property `` - section: general/border-and-outline - @iulia-zburlea
1. the `border-top-left-radius` property ``` - section: general/border-and-outline - @iulia-zburlea
1. the `border-bottom-right-radius` property - section: general/border-and-outline - @iulia-zburlea
1. the `border-bottom-left-radius` property - section: general/border-and-outline - @iulia-zburlea
1. the `box-decoration-break` property ````` - section: general/border-and-outline - @iulia-zburlea
